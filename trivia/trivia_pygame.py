...
class Trivia(object):
    ...
    def game_over(self):
        ...
        print_text(font1, 100, 100, "GAME OVER", white)
        print_text(font2, 20, 240, "Would you like to play again? (y/n)", white)
...
#main program begins
pygame.init()
space = pygame.image.load("background3.jfif")
space = pygame.transform.scale(space, (600, 500))
